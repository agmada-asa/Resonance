...
def create_dataloaders(mean, std):
    ...
    train_dataset = SyntheticSpectrogramDataset(DATA_DIR / "train_pitch_only.npz", mean, std)
    val_dataset = SyntheticSpectrogramDataset(DATA_DIR / "val_pitch_only.npz", mean, std)
    test_dataset = SyntheticSpectrogramDataset(DATA_DIR / "test_pitch_only.npz", mean, std)
...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val_losses["delta_loss"] < best_val_delta_loss:
            ...
            torch.save(
                ...
                BUILD_DIR / "best_spectrogram_transition_model_pitch_only.pth",
            )
    ...
    torch.save(
        ...
        BUILD_DIR / "spectrogram_transition_model_pitch_only_1.pth",
    )
